...
category_questions1 = [{"Question": "Test question 1", "Answer": "answer 1", "Value": 2},
                       {"Question": "Test question 2",
                           "Answer": "answer 2", "Value": 4},
                       {"Question": "Test question 3",
                           "Answer": "answer 3", "Value": 6},
                       {"Question": "Test question 4",
                           "Answer": "answer 4", "Value": 8},
...
category_questions2 = [{"Question": "Test question 6", "Answer": "answer 6", "Value": 4},
                       {"Question": "Test question 7",
                           "Answer": "answer 7", "Value": 8},
                       {"Question": "Test question 8",
                           "Answer": "answer 8", "Value": 12},
                       {"Question": "Test question 9",
                           "Answer": "answer 9", "Value": 16},
...
class Player:
    ...
    def playerTurn(self, question_bank_list_of_dicts, position):
        ...
        print(categories)
        category_choice = input("Select your category")
        if category_choice == 1:
            r = random.choice(list(category_questions1))
